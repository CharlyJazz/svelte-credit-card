...
<style>
  ...
  .rccs__card--discover .rccs__card--front,
  .rccs__card--mastercard .rccs__card--front,
  .rccs__card--maestro .rccs__card--front,
  .rccs__card--dinersclub .rccs__card--front,
  .rccs__card--discover .rccs__card--back,
  .rccs__card--mastercard .rccs__card--back,
  .rccs__card--maestro .rccs__card--back,
  .rccs__card--dinersclub .rccs__card--back {
    color: #4d4d4d;
  }
